...
// home page paints is VetPres's, a client of the studio; the captions name the client only once
...
// page. Their real site is further down." with the consent and the journey section.
