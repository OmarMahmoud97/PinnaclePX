...
// so a retry overwrites itself. A wordmark has nothing to analyse. Any failure means the
// wordmark: a prospect never sees a broken logo, and the stage says why in the log.
